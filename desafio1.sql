...
CREATE TABLE
    SpotifyClone.users(
        ...
        id_plano_user INT NOT NULL,
        FOREIGN KEY (id_plano_user) REFERENCES tipos_planos (id_plano)
    ) ENGINE = InnoDB;
...
CREATE TABLE
    SpotifyClone.seguindo_artista(
        -- id_seguindo_artista INT PRIMARY KEY AUTO_INCREMENT,
        id_seguindo_usuario INT NOT NULL,
        id_seguindo_artista INT NOT NULL,
        FOREIGN KEY (id_seguindo_usuario) REFERENCES users (id_usuario),
        FOREIGN KEY (id_seguindo_artista) REFERENCES artistas (id_artista),
        PRIMARY KEY (
            id_seguindo_usuario,
            id_seguindo_artista
        )
...
CREATE TABLE
    SpotifyClone.albuns(
        ...
        FOREIGN KEY (id_artista_album) REFERENCES artistas (id_artista)
    ) engine = InnoDB;
...
CREATE TABLE
    SpotifyClone.musicas(
        ...
        id_album_musica INT NOT NULL,
        FOREIGN KEY (id_album_musica) REFERENCES albuns (id_album)
    ) engine = InnoDB;
...
CREATE TABLE
    SpotifyClone.historico(
        ...
        FOREIGN KEY (id_musica_historico) REFERENCES musicas (id_musica),
        FOREIGN KEY (id_usuario_historico) REFERENCES users (id_usuario),
        PRIMARY KEY (
            id_musica_historico,
...
INSERT INTO
    SpotifyClone.artistas (nome_artista)
...
INSERT INTO
    SpotifyClone.tipos_planos (plano, valor)
